...
Or you can instead do C<use base 'Limper::SendFile'> in
B<My::Limper::Extension>, and you don't need to explicitly use it in your
app.  This gives you the features it adds as well.
